...
abnormal_data = adg.generate_abnormal_data_from_raw_data(overwrite_data=False,
                                                         generate_graph=True, show_graph=False)
...
output_string += 'The standard deviation of detection abnormality with {} models is {:.2f}%.\n'\
    .format(results_array.shape[0], np.std(abnormal_ratios)*100.0)
