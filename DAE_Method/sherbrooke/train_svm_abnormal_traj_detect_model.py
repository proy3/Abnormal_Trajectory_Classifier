"""
Train Abnormal trajectory detection with SVM Classifier model.
"""
import warnings
...
trad_method_name = 'One-Class SVM'
...
abnormal_data = adg.generate_abnormal_data(n_objects=20, generate_graph=True, show_graph=False)
