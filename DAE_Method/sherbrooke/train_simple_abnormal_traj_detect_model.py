"""
Train Abnormal trajectory detection with single layer autoencoder.
"""
import warnings
...
# Files setup
test_score_filename = 'results/single_ae/test_scores.csv'
...
model_files_dir_name = 'model/single_ae/'
...
output_string = 'Global summary of abnormal trajectory detection with single autoencoder\n'
output_string += '-----------------------------------------------------------------------\n'
