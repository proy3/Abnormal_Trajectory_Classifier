...
# Files setup
test_score_filename = 'results/deep_bigan_aae/test_scores.csv'
...
model_files_dir_name = 'model/deep_bigan_aae/'
...
for i in range(aeu.repeat_number):
    ...
    aae = aeu.BuildSimpleBiGANAAE(original_dim=train_data.shape[1],
...
output_string = 'Global summary of abnormal trajectory detection with deep bidirectional GAN with AAE\n'
output_string += '------------------------------------------------------------------------------------\n'
