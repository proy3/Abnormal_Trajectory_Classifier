...
# Files setup
test_score_filename = 'results/deep_bigan/test_scores.csv'
...
model_files_dir_name = 'model/deep_bigan/'
...
for i in range(aeu.repeat_number):
    ...
    aae = aeu.BuildSimpleBiGAN(original_dim=train_data.shape[1],
...
output_string = 'Global summary of abnormal trajectory detection with deep bidirectional GAN\n'
output_string += '---------------------------------------------------------------------------\n'
